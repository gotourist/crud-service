...
import (
	...
	"github.com/iman_task/crud-service/config"
	"github.com/iman_task/crud-service/events/handlers"
	loggerPkg "github.com/iman_task/crud-service/pkg/logger"
	messageBrokerPkg "github.com/iman_task/crud-service/pkg/messagebroker"
...
func NewKafkaConsumer(db *sqlx.DB, conf *config.Config, logger loggerPkg.Logger, topic string) messageBrokerPkg.Consumer {
	...
	return &KafkaConsumer{
		...
		eventHandler: handlers.NewEventHandler(storage.NewStoragePg(db), logger, *conf),
		logger:       logger,
	}
}
